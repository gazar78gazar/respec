...
export class SemanticIntegrationService {
  ...
  async processExtractedRequirements(
    ...
    try {
      ...
      if (extractedNodes.length === 0) {
        console.log("[SemanticIntegration] ⚠️  No specifications to match");
        return {
          success: true,
      ...
      // Match to UC
      console.log("[SemanticIntegration] 🔍 Sending to SemanticExtractor...");
      const matchResults =
  ...
  private async handleSpecificationMatch(
    ...
    if (!this.artifactManager) {
      console.error(`[Route] ⚠️  No artifact manager`);
      return;
    }
